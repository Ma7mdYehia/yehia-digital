  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col gap-10">
        ...
        {/* Header + mode buttons + summary — all above the panel */}
        <div className="flex flex-col gap-6 max-w-2xl">
          ...
          <motion.div {...reveal(0.18)} className="flex flex-col gap-2.5">
            <div className="flex flex-wrap gap-2" role="group" aria-label="Operating model view">
          ...
          {/* Summary — above the panel */}
          <motion.div {...reveal(0.22)} className="flex flex-col gap-2">
        ...
        >
          ...
          {/* Inner workspace: points (left) + visual (right) */}
          <div className="relative grid grid-cols-1 lg:grid-cols-2">

            {/* Capability points */}
            <ul className="p-7 lg:p-8 flex flex-col gap-3.5">
            ...
            <div className="p-7 lg:p-8 border-t border-white/[0.07] lg:border-t-0 lg:border-l lg:border-white/[0.08] flex items-center justify-center">
              <SystemsVisual />
            </div>
          </div>

          {/* Tags row — inside the panel, below the workspace */}
